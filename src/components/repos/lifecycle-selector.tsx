...
export function LifecycleSelector({ repoId, current }: LifecycleSelectorProps) {
  const [value, setValue] = useState<LifecycleStage>(
    (current as LifecycleStage) ?? 'maintaining'
  )
