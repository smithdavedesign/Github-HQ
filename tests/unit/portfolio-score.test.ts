...
describe('portfolioGrade', () => {
  it('returns A for 90+', () => expect(portfolioGrade(90).grade).toBe('A'))
  it('returns B for 80-89', () => expect(portfolioGrade(85).grade).toBe('B'))
  it('returns C for 70-79', () => expect(portfolioGrade(75).grade).toBe('C'))
  it('returns D for 60-69', () => expect(portfolioGrade(65).grade).toBe('D'))
  it('returns F for <60', () => expect(portfolioGrade(55).grade).toBe('F'))
  it('returns label for each grade', () => {
    expect(portfolioGrade(90).label).toBe('Excellent')
    expect(portfolioGrade(80).label).toBe('Great')
    expect(portfolioGrade(70).label).toBe('Good')
    expect(portfolioGrade(60).label).toBe('Fair')
    expect(portfolioGrade(50).label).toBe('Needs Work')
  })
})
